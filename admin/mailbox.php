            ...
            <div class="box-body no-padding">
              ...
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  ...
                  <button type="button" title="reply" class="btn btn-default btn-sm"><i class="fa fa-reply"></i></button>
                  <button type="button" title="forward" class="btn btn-default btn-sm"><i class="fa fa-share"></i></button>
                </div>
                <!-- /.btn-group -->
                <a href="mailbox"><button type="button" title="refresh" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
              ...
              <div class=" mailbox-messages">
                <table class="table table-hover table-striped datatable">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail_<?php echo encode($value->id);?>"><?php $sender = new User($value->from); echo $sender->data()->name;?></a></td>
  ...
  $(document).ready(function () {
    ...
    $(document).on('click', 'button[title=delete]', function(e) {
      ...
      if($clicked.length > 0) {
        ...
        $.post('-mail', {id: $clicked, action: 'delete', who: 'receiver'}, function($result) {
          if($result == 1) {
      ...
      }).on('click', 'button[title=reply]', function(e) {
        var $clicked = [];
      $('input[name^=markedMails]').filter(':checked').each(function(i,val) {
        $clicked.push($(this).val());
      });
